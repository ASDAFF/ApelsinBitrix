...
<!--											<input size="30" type="text" name="REGISTER[--><?//=$FIELD?><!--]" value="--><?//=$arResult["VALUES"][$FIELD]?><!--" />-->
					...
					if ($arResult["USE_CAPTCHA"] == "Y")
					{
						...
						<tr>
							<td>
								<div class="field">
									<label class="field-title"><?=GetMessage("REGISTER_CAPTCHA_PROMT")?><span class="starrequired">*</span></label>
									<div class="form-input">
...
<!--												<input type="submit" name="register_submit_button" class="btn_buy popdef" value="--><?//=GetMessage("AUTH_REGISTER")?><!--" />-->
<!--												<button type="submit" name="Register" class="btn_buy popdef" value="--><?//=GetMessage("AUTH_REGISTER")?><!--">--><?//=GetMessage("AUTH_REGISTER")?><!--</button>	-->
												<button type="submit" name="register_submit_button" class="btn_buy popdef" value="<?=GetMessage("AUTH_REGISTER")?>"><?=GetMessage("AUTH_REGISTER")?></button>
											</div>
