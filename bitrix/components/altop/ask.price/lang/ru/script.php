...
$MESS ['MF_ASK_PRICE_MESSAGE_TITLE'] = "Запрос цены";
$MESS ['MF_ORDER_MESSAGE_TITLE'] = "Заказ товара";
$MESS ['MF_MESSAGE_INFO'] = "Информационное сообщение сайта";
$MESS ['MF_ASK_PRICE_MESSAGE_ZAKAZ'] = "Осуществлен запрос цены";
$MESS ['MF_ORDER_MESSAGE_ZAKAZ'] = "Осуществлен заказ товара";
