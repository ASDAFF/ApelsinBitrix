(function (window) {
	...
	window.JCCatalogSectionDisc.prototype.Add2Basket = function() {
	...
	window.JCCatalogSectionDisc.prototype.BasketResult = function() {
		var close,
			strContent,
			strPictSrc,
			strPictWidth,
	...
	window.JCCatalogSectionDisc.prototype.BasketRedirect = function() {
