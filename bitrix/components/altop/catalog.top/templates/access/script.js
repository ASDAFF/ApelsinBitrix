(function (window) {
	...
	window.JCCatalogSectionAcs.prototype.SelectProp = function() {
		...
		if(!!this.offers && 0 < this.offers.length) {
			for(i = 0; i < this.offers.length; i++) {
				...
				/*MIN_DELAY*/
				if(!!BX('catalog-item-delay-acs-min-'+this.offers[i].ID)) {
					MinselDelayOnclick = BX('catalog-item-delay-acs-min-'+this.offers[i].ID).getAttribute('onclick');
					...
					BX('catalog-item-delay-acs-min-'+this.offers[i].ID).setAttribute('onclick', MinselDelayOnclickNew);					
				}
				/*DELAY*/
				if(!!BX('catalog-item-delay-acs-'+this.offers[i].ID)) {
					selDelayOnclick = BX('catalog-item-delay-acs-'+this.offers[i].ID).getAttribute('onclick');
					selDelayOnclickArr = selDelayOnclick.split("',");
					selDelayOnclickArr[3] = " '"+selPropValue;
					selDelayOnclickNew = selDelayOnclickArr.join("',");
					BX('catalog-item-delay-acs-'+this.offers[i].ID).setAttribute('onclick', selDelayOnclickNew);
				}
			}
		} else {
			/*CART*/
	...
	window.JCCatalogSectionAcs.prototype.Add2Basket = function() {
	...
	window.JCCatalogSectionAcs.prototype.BasketResult = function() {
		var close,
			strContent,
			strPictSrc,
			strPictWidth,
	...
	window.JCCatalogSectionAcs.prototype.BasketRedirect = function() {
